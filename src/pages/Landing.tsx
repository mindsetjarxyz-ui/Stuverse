...
import { BookOpen, MessageSquare, FileText, CheckSquare, Calendar, Zap, ArrowRight, BrainCircuit, Shield, Sparkles, Star, X, Mail, Lock, AlertCircle } from 'lucide-react';
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center border border-border-glass mx-auto mb-4">
                  <BookOpen className="w-6 h-6 text-gray-200" />
                </div>
                <h3 className="text-2xl font-heading font-bold text-white">
                  {isSignUp ? 'Join Stuverse AI' : 'Welcome back'}
                </h3>
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/5 border border-border-glass rounded-xl py-3 pl-11 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-white/10 transition-all"
                    />
                  </div>
                </div>
                ...
                <button 
                  disabled={loading}
                  className="w-full py-4 glass-pill text-white font-semibold flex items-center justify-center gap-2 hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                >
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#0B0B0C] px-2 text-gray-500">Or continue with</span>
                </div>
              </div>
              ...
              <button 
                ...
                disabled={loading}
                className="w-full py-4 glass-pill text-white font-semibold flex items-center justify-center gap-3 hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <div className="mt-8 text-center text-sm">
                <p className="text-gray-400">
                  ...
                  >
                    {isSignUp ? 'Sign In' : 'Join Stuverse'}
                  </button>
                </p>
              </div>
            </motion.div>
              ...
              <div className="w-full h-full flex items-center justify-center bg-black/40">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 max-w-md mx-auto">
                    We're currently preparing a comprehensive walkthrough of Stuverse AI. Check back soon to see it in action!
                  </p>
                </div>
              </div>
            </motion.div>
